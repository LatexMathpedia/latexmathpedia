...
// nunca se llama, así que las peticiones van sin Authorization (ver MIGRATION.md T-13:
// endpoints protegidos del backend devolverán 401 real en modo mock, es esperado).
